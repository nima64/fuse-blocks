const FDIcon = (
<svg width="100%" height="100%" viewBox="0 0 221 158" version="1.1" xmlns="http://www.w3.org/2000/svg" style={{fillRule:'evenodd',clipRule:'evenodd',strokeLinejoin:'round',strokeMiterlimit:2}}>
    <g transform="matrix(1,0,0,1,-2.07806,-33.7657)">
        <g id="path222" transform="matrix(1.33333,0,0,-1.33333,0,1333.33)">
            <path d="M159.253,952.279L165.463,948.299C166.985,947.321 167.625,945.588 166.88,944.429C166.139,943.274 164.3,943.133 162.774,944.108L156.566,948.092L150.746,939.021L156.951,935.038C158.479,934.057 159.115,932.327 158.374,931.173C157.627,930.012 155.792,929.87 154.268,930.847L148.061,934.835L145.075,930.176C131.914,938.618 125.009,951.338 129.66,958.591C134.306,965.837 148.747,964.863 161.912,956.417L159.253,952.279Z" style={{fill:"rgb(43,57,144)",fillRule:"nonzero"}}/>
        </g>
        <g id="path246" transform="matrix(1.33333,0,0,-1.33333,0,1333.33)">
            <path d="M42.844,947.559C35.762,944.314 28.667,940.211 21.373,935.106L15.575,931.048L1.559,857.245L20.855,857.245L27.689,893.692L59.044,893.692L62.26,909.906L30.77,909.906L34.925,931.077L68.424,931.077L71.64,947.559L42.844,947.559Z" style={{fill:"url(#_Linear1)",fillRule:"nonzero"}}/>
        </g>
        <g id="path266" transform="matrix(1.33333,0,0,-1.33333,0,1333.33)">
        ...
        <g id="path226" transform="matrix(1.33333,0,0,-1.33333,0,1333.33)">
    ...
    <defs>
        <linearGradient id="_Linear1" x1="0" y1="0" x2="1" y2="0" gradientUnits="userSpaceOnUse" gradientTransform="matrix(1.04876e-14,-171.276,171.276,1.04876e-14,36.5995,974.615)"><stop offset="0" style={{stopColor:'rgb(43,57,144)',stopOpacity:1}}/><stop offset="1" style={{stopColor:'rgb(43,0,97)',stopOpacity:1}}/></linearGradient>
        <linearGradient id="_Linear2" x1="0" y1="0" x2="1" y2="0" gradientUnits="userSpaceOnUse" gradientTransform="matrix(6.77001e-15,-110.563,110.563,6.77001e-15,104.379,940.984)"><stop offset="0" style={{stopColor:'rgb(39,170,225)',stopOpacity:1}}/><stop offset="1" style={{stopColor:'rgb(0,122,255)',stopOpacity:1}}/></linearGradient>
    </defs>
</svg>
);
