...
/***/ "./blocks/my-cases/Custom_InspectorControls.js":
/*!*****************************************************!*\
  !*** ./blocks/my-cases/Custom_InspectorControls.js ***!
  \*****************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return CustomInspectorControls; });
...
/* harmony import */ var _lib_createControlRenderer__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../lib/createControlRenderer */ "./lib/createControlRenderer.js");
...
function CustomInspectorControls(props) {
  var ControlsData = props.ControlsData;
  var renderControlObj = Object(_lib_createControlRenderer__WEBPACK_IMPORTED_MODULE_4__["default"])(props);

  var getDisplayPlanel = function getDisplayPlanel() {
    var DisplayGroup = ControlsData.display;
  ...
  var getTextPanel = function getTextPanel() {
    ...
    var avaliableLabels = selectedColumns.filter(function (col_name) {
      return TextColumnsGroup[col_name] != undefined;
    });
    var columnLabels = avaliableLabels.map(function (col_name) {
      return TextColumnsGroup[col_name];
    });
    return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__["Panel"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__["PanelBody"], {
      title: "Text"
    }, columnLabels.map(function (obj) {
      return renderControlObj(obj);
    }), Object.entries(TextGroup).map(function (_ref4) {
  ...
  var getAdvancedPanel = function getAdvancedPanel() {
    var AdvancedGroup = ControlsData.advanced;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return MockData; });
...
var MockData = /*#__PURE__*/function () {
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(MockData, [{
    ...
    value: function orderBy(orders) {
      ...
      var whichsort = function whichsort(id) {
        var id_s = id.split(" ");

        if (id_s[1] == "asc") {
          //sort smallest to largest
          _this2.cases.sort(function (a, b) {
            return a[id_s[0]] - b[id_s[0]];
          });
        }
...
/***/ "./blocks/my-cases/RenderTable.js":
/*!****************************************!*\
  !*** ./blocks/my-cases/RenderTable.js ***!
  \****************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return RenderTable; });
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/element */ "@wordpress/element");
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var locutus_php_datetime_date__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! locutus/php/datetime/date */ "./node_modules/locutus/php/datetime/date.js");
/* harmony import */ var locutus_php_datetime_date__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(locutus_php_datetime_date__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _MockData__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./MockData */ "./blocks/my-cases/MockData.js");
/* harmony import */ var _mockdata_json__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./mockdata.json */ "./blocks/my-cases/mockdata.json");
var _mockdata_json__WEBPACK_IMPORTED_MODULE_3___namespace = /*#__PURE__*/__webpack_require__.t(/*! ./mockdata.json */ "./blocks/my-cases/mockdata.json", 1);
...
function formatTimeStamp(timestamp) {
  ...
  return locutus_php_datetime_date__WEBPACK_IMPORTED_MODULE_1___default()(format, timestamp);
}
/**
...
function RenderTable(props) {
  ...
  mockData.filterByStatus(attributes.status).slice(0, attributes.limit).map(function (_case) {
    ...
    }), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("td", null));
  })));
}

/***/ }),

/***/ "./blocks/my-cases/attributes.js":
/*!***************************************!*\
  !*** ./blocks/my-cases/attributes.js ***!
  \***************************************/
/*! exports provided: default */
...
Object(_wordpress_blocks__WEBPACK_IMPORTED_MODULE_3__["registerBlockType"])('fusedesk/team-cases', {
   ...
   */
  apiVersion: 2,
  icon: Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_wordpress_icons__WEBPACK_IMPORTED_MODULE_4__["Icon"], {
...
/* harmony import */ var _ControlData_TeamCases__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./ControlData_TeamCases */ "./blocks/team-cases/ControlData_TeamCases.js");
...
/*!**************************!*\
  !*** ./lib/shortcode.js ***!
  \**************************/
/*! exports provided: createShortCodeAttFromGroup */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createShortCodeAttFromGroup", function() { return createShortCodeAttFromGroup; });
/* harmony import */ var _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/slicedToArray */ "./node_modules/@babel/runtime/helpers/slicedToArray.js");
/* harmony import */ var _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_0__);
...
function createShortCodeAttFromObj(obj, attributes) {
  var attName = obj.bind;
  var attval = attributes[attName];
  var val = convertCompounDataToStr(obj.type, attval); //check that the value isn't false or empty

  return !!val && val !== '' ? "".concat(attName, "=\"").concat(val, "\" ") : '';
}

function createShortCodeAttFromGroup(group, controlsData, attributes) {
  var objs = Object.entries(controlsData[group]).map(function (_ref) {
    var _ref2 = _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_0___default()(_ref, 2),
        name = _ref2[0],
        obj = _ref2[1];
  ...
  var shortcodeAtts = objs.map(function (obj) {
    return createShortCodeAttFromObj(obj, attributes);
  });
  var str = shortcodeAtts.join(' ');
  return str;
}
