...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return NewCaseInspectorControls; });
...
function NewCaseInspectorControls(props) {
  ...
  var getCaseCreationPanel = function getCaseCreationPanel() {
    ...
    var RefreshButton = function RefreshButton(props) {
      ...
      }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_wordpress_icons__WEBPACK_IMPORTED_MODULE_5__["Icon"], {
        icon: refreshIcon
      }));
    };

    return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__["Panel"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__["PanelBody"], {
      title: "Case Creation"
    ...
    }, renderControlObj(controlsData[0], 'caseCreation')), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(RefreshButton, null)), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("div", {
      style: {
        display: 'flex',
        alignItems: 'flex-end'
      }
    ...
    }, renderControlObj(controlsData[1], 'caseCreation')), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(RefreshButton, null)), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("div", {
      style: {
        display: 'flex',
        alignItems: 'flex-end'
      }
    ...
    }, renderControlObj(controlsData[2], 'caseCreation')), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(RefreshButton, null))));
  };
  ...
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__["InspectorControls"], null, getCaseCreationPanel(), getNewCaseFormPanel(), getCaseTitlePanel(), getFormTextPanel(), getSuggestedPostsPanel(), getFileUploadsPanel());
}
...
/* harmony import */ var _lib_createControlRenderer__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../lib/createControlRenderer */ "./lib/createControlRenderer.js");
/* harmony import */ var _NewCaseInspectorControls__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./NewCaseInspectorControls */ "./blocks/new-case/NewCaseInspectorControls.js");
...
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./editor.scss */ "./blocks/new-case/editor.scss");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_15___default = /*#__PURE__*/__webpack_require__.n(_editor_scss__WEBPACK_IMPORTED_MODULE_15__);
/* harmony import */ var _fdico__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../../fdico */ "./fdico.js");
...
function composeOptionsFetcher(normalizer) {
  ...
  return function (options, endpoint) {
    ...
    fetch(FETCHURL, {
      ...
      var refreshbtn = document.body.querySelector('#refreshme');
      if (refreshbtn) refreshbtn.click();
    });
  };
}

var fetchOptions = composeOptionsFetcher(normJsonToOptions);
var refreshOptions = composeOptionsFetcher(normJsonToOptions, true);

var normCat = function normCat(jsonData) {
...
var fetchCategories = composeOptionsFetcher(normCat); // const repOptions = controls.caseCreation[0].options
...
var OptionsPuller = /*#__PURE__*/function (_React$Component) {
  ...
  function OptionsPuller(props) {
    ...
    _this.repOptions = _controlsData__WEBPACK_IMPORTED_MODULE_14__["default"].caseCreation[0].options;
    _this.deptOptions = _controlsData__WEBPACK_IMPORTED_MODULE_14__["default"].caseCreation[1].options;
    _this.casetagOptions = _controlsData__WEBPACK_IMPORTED_MODULE_14__["default"].caseCreation[2].options;
    _this.categoryOptions = _controlsData__WEBPACK_IMPORTED_MODULE_14__["default"].suggestedPosts[3].options;
    return _this;
  }
...
function Edit(props) {
  ...
  var renderControlObj = Object(_lib_createControlRenderer__WEBPACK_IMPORTED_MODULE_11__["default"])(props); //for debugging purposes only

  var displayShortCodeAtts = function displayShortCodeAtts(_ref3) {
    var _ref4 = _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_6___default()(_ref3, 1),
        ary = _ref4[0];

    return Object.entries(ary).map(function (_ref5) {
      var _ref6 = _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_6___default()(_ref5, 2),
          k = _ref6[0],
          v = _ref6[1];
  ...
  var displayAllShortCodeAtts = function displayAllShortCodeAtts() {
    return Object.entries(attributes).map(function (_ref7) {
      var _ref8 = _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_6___default()(_ref7, 2),
          k = _ref8[0],
          v = _ref8[1];
  ...
  var getRefreshButton = function getRefreshButton() {
    return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])("button", {
      ...
      onClick: function onClick() {
        ...
        var inc = attributes.refreshme + 1;
        setAttributes({
          refreshme: inc
        });
      }
  ...
  var getRefreshOptionsButton = function getRefreshOptionsButton(option) {
    return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])("button", {
      id: 'refreshme',
      style: {
        opacity: '0',
  ...
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])("div", Object(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_9__["useBlockProps"])(), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])(OptionsPuller, null), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])(_NewCaseInspectorControls__WEBPACK_IMPORTED_MODULE_12__["default"], props), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_10__["Placeholder"] // icon={<Icon icon={FDIcon} />}
  , {
  ...
  }), "\xA0 Click on the settings icon to start customizing!"));
}
