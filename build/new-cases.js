...
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./editor.scss */ "./blocks/new-cases/editor.scss");
...
var fetchOptions = function fetchOptions(options, endpoint) {
  fetch(WP_BASEURL + endpoint, {
    method: 'GET'
  }).then(function (req) {
    return req.json();
  }).then(function (json) {
    normRepsToOptions(json).forEach(function (v, i) {
      options[i] = v;
    }); //takes normalized options and inserts them into options
...
function Edit(props) {
  ...
  */
  ...
  var renderControlObj = Object(_lib_createControlRenderer__WEBPACK_IMPORTED_MODULE_11__["default"])(props);
  ...
  var getCaseCreationPanel = function getCaseCreationPanel() {
    ...
    return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_10__["Panel"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_10__["PanelBody"], {
      title: "Case Creation"
    }, controlsData.map(function (v) {
      return renderControlObj(v, 'caseCreation');
    })));
  };
  ...
  var getNewCaseFormPanel = function getNewCaseFormPanel() {
    return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_10__["Panel"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_10__["PanelBody"], {
      title: "New Case Form"
    }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_10__["CheckboxControl"], {
      label: "Hide Known Data?",
      checked: newCaseForm[0].hideknowndata,
      onChange: function onChange() {
        mutAryItem(!newCaseForm[0].hideknowndata, 'hideknowndata', 'newCaseForm');
      }
  ...
  var getCaseTitlePanel = function getCaseTitlePanel() {
    return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_10__["Panel"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_10__["PanelBody"], {
      ...
      onChange: function onChange(v) {
        return mutAryItem(v, 'showtitle', 'caseTitle');
      }
    }), ///show other options only when showtitle checked
    caseTitle[0].showtitle && Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["Fragment"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_10__["TextControl"], {
  ...
  var getFormTextPanel = function getFormTextPanel() {
    ...
    return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_10__["Panel"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_10__["PanelBody"], {
      title: "Form Text"
    }, textControldata.map(function (v) {
  ...
  var getFileUploadsPanel = function getFileUploadsPanel() {
    ...
    return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_10__["Panel"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_10__["PanelBody"], {
      title: "File Uploads"
    }, fileUploads[0].fileupload ? controlsData.map(function (v) {
  ...
  var getInspectorControls = function getInspectorControls() {
    return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_9__["InspectorControls"], null, getCaseCreationPanel(), getNewCaseFormPanel(), getCaseTitlePanel(), getFormTextPanel(), getSuggestedPostsPanel(), getFileUploadsPanel());
  ...
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])("div", Object(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_9__["useBlockProps"])(), getInspectorControls(), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])(OptionsPuller, null), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_10__["Placeholder"], {
...
/* harmony import */ var _fdico__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../fdico */ "./fdico.js");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./style.scss */ "./blocks/new-cases/style.scss");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_style_scss__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./edit */ "./blocks/new-cases/edit.js");
/* harmony import */ var _save__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./save */ "./blocks/new-cases/save.js");
...
Object(_wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__["registerBlockType"])('fusedesk/new-case', {
  /**
...
var FDIcon = Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("svg", {
  ...
  d: "M1087 2184 c-251 -39 -512 -173 -701 -360 -66 -65 -146 -163 -146\r\n-179 0 -4 22 21 49 56 112 146 268 272 443 357 96 47 245 99 254 89 2 -2 -31\r\n-14 -73 -27 -166 -48 -356 -158 -488 -281 -69 -65 -165 -180 -165 -197 0 -25\r\n22 -19 87 24 95 63 330 177 440 213 165 54 272 72 468 78 207 6 334 -8 511\r\n-58 l109 -30 17 21 c10 12 18 28 18 35 0 7 14 29 30 50 37 46 32 53 -59 100\r\n-92 46 -247 93 -360 110 -118 18 -316 18 -434 -1z"
}), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("path", {
  d: "M2030 2014 c-78 -34 -126 -109 -117 -185 6 -51 42 -129 77 -169 l22\r\n-25 -16 25 c-27 41 -66 124 -66 140 0 8 11 -11 25 -44 13 -32 42 -80 65 -108\r\n23 -27 40 -51 37 -54 -2 -2 -12 7 -21 22 -10 14 -20 23 -24 20 -7 -8 78 -96\r\n93 -96 5 1 -3 12 -20 25 -16 14 -25 25 -19 25 5 0 26 -17 45 -37 18 -20 25\r\n-31 14 -23 -20 15 -20 14 -1 -8 19 -22 43 -31 30 -11 -3 6 5 3 20 -6 15 -10\r\n28 -16 29 -14 2 2 12 18 23 36 l19 32 55 -35 c58 -36 79 -41 98 -22 27 27 13\r\n57 -43 94 -30 20 -55 40 -55 43 0 3 17 32 38 63 l38 57 54 -34 c59 -37 79 -42\r\n98 -23 27 27 13 57 -43 94 -30 20 -55 40 -55 44 0 3 7 15 15 26 8 10 15 24 15\r\n30 0 15 -165 90 -228 103 -101 21 -192 10 -235 -27 -9 -8 -20 -13 -23 -10 -14\r\n14 71 51 129 55 89 7 169 -11 275 -62 90 -43 105 -58 80 -83 -6 -6 -9 -15 -5\r\n-18 3 -4 12 6 19 21 11 25 10 29 -12 48 -102 83 -334 133 -430 91z"
}), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("path", {
  d: "M1273 1787 c-50 -7 -95 -16 -100 -21 -5 -5 0 -6 10 -3 10 4 61 9 115\r\n11 53 2 81 2 62 0 -19 -2 -73 -9 -120 -15 -47 -6 -88 -13 -92 -17 -3 -4 -38\r\n-176 -77 -382 -39 -206 -76 -395 -81 -420 -31 -148 -91 -475 -93 -506 -2 -34\r\n0 -37 28 -39 17 -1 100 -8 185 -15 302 -25 551 9 728 99 23 12 42 19 42 16 0\r\n-9 -99 -55 -172 -79 -95 -31 -196 -46 -388 -56 l-155 -9 171 4 c243 6 391 39\r\n534 119 55 30 190 143 190 158 0 5 -29 -17 -65 -50 -36 -34 -75 -66 -87 -72\r\n-15 -7 -12 -3 7 12 17 12 61 52 100 88 38 36 63 56 56 45 -7 -11 3 -2 24 20\r\n48 53 120 200 145 297 10 42 22 114 25 160 7 87 -7 228 -26 256 -9 15 -10 15\r\n-5 -1 3 -9 8 -48 10 -85 6 -78 2 -68 -15 41 -6 42 -16 77 -21 77 -5 0 -6 -5\r\n-2 -12 4 -7 3 -8 -5 -4 -6 4 -9 11 -7 15 3 4 -26 29 -64 56 -80 54 -150 128\r\n-191 201 -39 68 -52 78 -129 99 -83 22 -403 29 -537 12z m478 -298 c22 -11 37\r\n-23 35 -28 -3 -4 8 -20 24 -36 126 -121 94 -463 -60 -638 -76 -86 -218 -137\r\n-382 -137 -61 0 -68 2 -68 19 0 11 15 98 34 193 18 95 53 276 77 402 51 265\r\n42 252 170 242 68 -6 108 -14 184 -40 11 -4 8 0 -7 8 -15 9 -51 23 -80 31 -52\r\n15 -52 15 -10 10 24 -3 62 -15 83 -26z"
}), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("path", {
  d: "M529 1737 c-118 -66 -287 -177 -315 -209 -16 -17 -28 -60 -48 -168\r\n-15 -80 -34 -176 -41 -215 -67 -330 -118 -623 -120 -687 l-3 -78 147 0 c80 0\r\n155 3 167 6 19 5 26 32 69 265 l49 259 230 2 230 3 3 30 c2 17 10 55 18 85 14\r\n52 13 43 -2 -55 -12 -78 5 -29 26 75 12 58 24 116 27 130 11 49 -8 11 -21 -42\r\nl-13 -53 5 58 6 57 -237 0 c-130 0 -236 3 -236 8 0 20 53 272 57 268 4 -3 -32\r\n-209 -43 -248 -5 -17 10 -18 228 -16 l233 3 -226 2 -226 3 26 130 25 130 246\r\n2 245 2 -255 6 -255 6 252 2 c228 2 253 4 262 20 8 12 10 13 11 3 0 -36 14 8\r\n36 121 27 140 27 138 14 118 -6 -10 -10 -11 -10 -2 0 9 -52 12 -225 12 l-225\r\n0 -83 -41 c-109 -55 -334 -204 -341 -226 -3 -10 -17 -81 -31 -158 -30 -160\r\n-57 -281 -49 -220 11 93 68 381 78 394 16 21 253 174 336 217 l75 39 230 5\r\n230 6 -230 2 -230 2 -96 -53z"
})));
/* harmony default export */ __webpack_exports__["default"] = (FDIcon);
