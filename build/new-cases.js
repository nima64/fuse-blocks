...
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./editor.scss */ "./blocks/new-cases/editor.scss");
...
var fetchOptions = function fetchOptions(options, endpoint) {
  fetch(WP_BASEURL + endpoint, {
    ...
    if (refreshbtn) refreshbtn.click(); // 		//REFRESH TEST
    // 		// setTimeout(() => {
...
function Edit(props) {
  ...
  */
  ...
  var mutAryItem = function mutAryItem(newval, key, aryName) {
    ...
    temp[0][key] = newval;
    setAttributes(_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()({}, aryName, temp));
  };

  var renderControlObj = function renderControlObj(obj) {
    // switch (obj.type) {
    // 	case 'check':
    // 		return (
    // 			<CheckboxControl  
    ...
    // 				onChange={(newval) => mutAryItem(newval,obj.bind,'fileUploads')} />);
    // }
    return obj.type == 'check' ? Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__["CheckboxControl"], {
      label: obj.label,
      checked: fileUploads[0][obj.bind],
      onChange: function onChange(newval) {
        return mutAryItem(newval, obj.bind, 'fileUploads');
      }
  ...
  var getCaseCreationPanel = function getCaseCreationPanel() {
    ...
    return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__["Panel"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__["PanelBody"], {
      ...
      onChange: function onChange(v) {
        return mutAryItem(v, 'department', 'caseCreation');
      }
    }), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__["SelectControl"], {
      ...
      onChange: function onChange(v) {
        return mutAryItem(v, 'rep', 'caseCreation');
      }
    }), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__["SelectControl"], {
      ...
      onChange: function onChange(v) {
        return mutAryItem(v, 'casetagids', 'caseCreation');
      }
    })));
  };
  ...
  var getCaseTitlePanel = function getCaseTitlePanel() {
    ...
    caseTitle[0].showtitle && Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["createElement"])(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["Fragment"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__["TextControl"], {
  ...
  var getFormTextPanel = function getFormTextPanel() {
    ...
    return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__["Panel"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__["PanelBody"], {
      title: "Form Text"
    }, textControldata.map(function (_ref3) {
      ...
      return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__["TextControl"], {
        ...
        onChange: function onChange(v) {
          return mutAryItem(v, bind, 'formText');
        }
      });
    })));
  };
  ...
  var getSuggestedPostsPanel = function getSuggestedPostsPanel() {
    ...
    return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__["Panel"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__["PanelBody"], {
      ...
      onChange: function onChange(v) {
        return mutAryItem(v, 'suggestionplacement', 'suggestedPosts');
      },
      options: placementOptions
    }), //only render/show when none is not selected
    suggestedPosts[0].suggestionplacement != 'none' && Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["createElement"])(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["Fragment"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__["TextControl"], {
      label: "Suggestions Label",
      placeholder: "May we suggest one of the following posts?",
      value: suggestedPosts[0].suggestionstext,
      onChange: function onChange(v) {
        return mutAryItem(v, 'suggestionstext', 'suggestedPosts');
      }
      ...
      onChange: function onChange(v) {
        return mutAryItem(v, 'suggestionlimit', 'suggestedPosts');
      }
    }), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__["SelectControl"], {
      label: "Suggestion Category",
      value: suggestedPosts[0].suggestioncategories,
      onChange: function onChange(v) {
        return mutAryItem(v, 'suggestioncategories', 'suggestedPosts');
      },
  ...
  var getFileUploadsPanel = function getFileUploadsPanel() {
    ...
    return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__["Panel"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__["PanelBody"], {
      title: "File Uploads"
    }, fileUploads[0].fileupload ? inputData.map(function (v) {
      return renderControlObj(v);
  ...
  var getInspectorControls = function getInspectorControls() {
    return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["createElement"])(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__["InspectorControls"], null, getCaseCreationPanel(), getNewCaseFormPanel(), getCaseTitlePanel(), getFormTextPanel(), getSuggestedPostsPanel(), getFileUploadsPanel());
  }; //for debugging purposes only


  var displayShortCodeAtts = function displayShortCodeAtts(_ref4) {
    var _ref5 = _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_1___default()(_ref4, 1),
        ary = _ref5[0];

    return Object.entries(ary).map(function (_ref6) {
  ...
  var displayAllShortCodeAtts = function displayAllShortCodeAtts() {
    return Object.entries(attributes).map(function (_ref8) {
